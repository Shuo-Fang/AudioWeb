...
(function($){
	...
	view = {
		...
		makeDOMNodeIcon: function(html, setting, node) {
			...
			style = isTextIcon?'':view.makeNodeIcoClass(setting, node),
			name = setting.view.nameIsHTML ? nameStr : nameStr.replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;');
			html.push("<span id='", node.tId, consts.id.ICON,
				"' title='' treeNode", consts.id.ICON," class='",textIcon, textIcon?"":view.makeNodeIcoClass(setting, node),
				"' style='",style?"":view.makeNodeIcoStyle(setting, node), "'></span><span id='", node.tId, consts.id.SPAN,
				"'>",name,"</span>");
		},
